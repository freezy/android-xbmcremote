...
public interface IInfoManager extends IManager {
	...
	public void getDirectory(final DataResponse<ArrayList<FileLocation>> response, final String path,
							 final DirectoryMask mask, final int offset, final int limit, final Context context,
							 final int mediaType);
	 ...
	 */
	public void setGuiSettingInt(final DataResponse<Boolean> response, final int field, final int val,
								 final Context context);
	 ...
	 */
	public void setGuiSettingBool(final DataResponse<Boolean> response, final int field, final boolean val,
								  final Context context);
