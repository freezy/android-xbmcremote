...
public class Movie implements ICoverArt, Serializable, INamedResource {
	 ...
	 */
	public Movie(int id, String title, int year, String path, String filename, String director, String runtime,
				 String genres, double rating, int numWatched, String imdbId, String artUrl) {
		this.id = id;
		this.title = title;
		this.year = year;
