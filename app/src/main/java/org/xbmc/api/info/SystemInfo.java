...
public class SystemInfo {
	...
	public static final int SYSTEM_ALWAYS_TRUE = 125;  // useful for <visible fade="10" start="hidden">true</visible>,
	// to fade in a control
	public static final int SYSTEM_ALWAYS_FALSE = 126;  // used for <visible fade="10">false</visible>,
	// to fade out a control (ie not particularly useful!)
