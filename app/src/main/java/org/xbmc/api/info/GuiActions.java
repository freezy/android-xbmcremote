...
public abstract class GuiActions {
	...
	public static final int ACTION_FORWARD = 16; // Can be used to specify specific action in a window,
	// Playback control is handled in ACTION_PLAYER_*
	public static final int ACTION_REWIND = 17; // Can be used to specify specific action in a window,
	// Playback control is handled in ACTION_PLAYER_*

	public static final int ACTION_SHOW_GUI = 18; // toggle between GUI and movie or GUI and visualisation.
	public static final int ACTION_ASPECT_RATIO = 19; // toggle quick-access zoom modes. Can b used in videoFullScreen
	// .zml window id=2005
	public static final int ACTION_STEP_FORWARD = 20; // seek +1% in the movie. Can b used in videoFullScreen.xml
	// window id=2005
	public static final int ACTION_STEP_BACK = 21; // seek -1% in the movie. Can b used in videoFullScreen.xml window
	// id=2005
	public static final int ACTION_BIG_STEP_FORWARD = 22; // seek +10% in the movie. Can b used in videoFullScreen.xml
	// window id=2005
	public static final int ACTION_BIG_STEP_BACK = 23; // seek -10% in the movie. Can b used in videoFullScreen.xml
	// window id=2005
	public static final int ACTION_SHOW_OSD = 24; // show/hide OSD. Can b used in videoFullScreen.xml window id=2005
	public static final int ACTION_SHOW_SUBTITLES = 25; // turn subtitles on/off. Can b used in videoFullScreen.xml
	// window id=2005
	public static final int ACTION_NEXT_SUBTITLE = 26; // switch to next subtitle of movie. Can b used in
	// videoFullScreen.xml window id=2005
	public static final int ACTION_SHOW_CODEC = 27; // show information about file. Can b used in videoFullScreen.xml
	// window id=2005 and in slideshow.xml window id=2007
	public static final int ACTION_NEXT_PICTURE = 28; // show next picture of slideshow. Can b used in slideshow.xml
	// window id=2007
	public static final int ACTION_PREV_PICTURE = 29; // show previous picture of slideshow. Can b used in slideshow
	// .xml window id=2007
	public static final int ACTION_ZOOM_OUT = 30; // zoom in picture during slideshow. Can b used in slideshow.xml
	// window id=2007
	public static final int ACTION_ZOOM_IN = 31; // zoom out picture during slideshow. Can b used in slideshow.xml
	// window id=2007
	public static final int ACTION_TOGGLE_SOURCE_DEST = 32; // used to toggle between source view and destination view
	// . Can be used in myfiles.xml window id=3
	public static final int ACTION_SHOW_PLAYLIST = 33; // used to toggle between current view and playlist view. Can b
	// used in all mymusic xml files
	public static final int ACTION_QUEUE_ITEM = 34; // used to queue a item to the playlist. Can b used in all mymusic
	// xml files
	...
	public static final int ACTION_ZOOM_LEVEL_NORMAL = 37; // zoom 1x picture during slideshow. Can b used in
	// slideshow.xml window id=2007
	public static final int ACTION_ZOOM_LEVEL_1 = 38; // zoom 2x picture during slideshow. Can b used in slideshow.xml
	// window id=2007
	public static final int ACTION_ZOOM_LEVEL_2 = 39; // zoom 3x picture during slideshow. Can b used in slideshow.xml
	// window id=2007
	public static final int ACTION_ZOOM_LEVEL_3 = 40; // zoom 4x picture during slideshow. Can b used in slideshow.xml
	// window id=2007
	public static final int ACTION_ZOOM_LEVEL_4 = 41; // zoom 5x picture during slideshow. Can b used in slideshow.xml
	// window id=2007
	public static final int ACTION_ZOOM_LEVEL_5 = 42; // zoom 6x picture during slideshow. Can b used in slideshow.xml
	// window id=2007
	public static final int ACTION_ZOOM_LEVEL_6 = 43; // zoom 7x picture during slideshow. Can b used in slideshow.xml
	// window id=2007
	public static final int ACTION_ZOOM_LEVEL_7 = 44; // zoom 8x picture during slideshow. Can b used in slideshow.xml
	// window id=2007
	public static final int ACTION_ZOOM_LEVEL_8 = 45; // zoom 9x picture during slideshow. Can b used in slideshow.xml
	// window id=2007
	public static final int ACTION_ZOOM_LEVEL_9 = 46; // zoom 10x picture during slideshow. Can b used in slideshow
	// .xml window id=2007

	public static final int ACTION_CALIBRATE_SWAP_ARROWS = 47; // select next arrow. Can b used in:
	// settingsScreenCalibration.xml windowid=11
	public static final int ACTION_CALIBRATE_RESET = 48; // reset calibration to defaults. Can b used in:
	// settingsScreenCalibration.xml windowid=11/settingsUICalibration.xml windowid=10
	public static final int ACTION_ANALOG_MOVE = 49; // analog thumbstick move. Can b used in: slideshow.xml window
	// id=2007/settingsScreenCalibration.xml windowid=11/settingsUICalibration.xml windowid=10
	public static final int ACTION_ROTATE_PICTURE = 50; // rotate current picture during slideshow. Can b used in
	// slideshow.xml window id=2007
	public static final int ACTION_CLOSE_DIALOG = 51; // action for closing the dialog. Can b used in any dialog
	public static final int ACTION_SUBTITLE_DELAY_MIN = 52; // Decrease subtitle/movie Delay.  Can b used in
	// videoFullScreen.xml window id=2005
	public static final int ACTION_SUBTITLE_DELAY_PLUS = 53; // Increase subtitle/movie Delay.  Can b used in
	// videoFullScreen.xml window id=2005
	public static final int ACTION_AUDIO_DELAY_MIN = 54; // Increase avsync delay.  Can b used in videoFullScreen.xml
	// window id=2005
	public static final int ACTION_AUDIO_DELAY_PLUS = 55; // Decrease avsync delay.  Can b used in videoFullScreen.xml
	// window id=2005
	public static final int ACTION_AUDIO_NEXT_LANGUAGE = 56; // Select next language in movie.  Can b used in
	// videoFullScreen.xml window id=2005
	public static final int ACTION_CHANGE_RESOLUTION = 57; // switch 2 next resolution. Can b used during screen
	// calibration settingsScreenCalibration.xml windowid=11
	...
	public static final int ACTION_OSD_SHOW_LEFT = 69;  // Move left in OSD. Can b used in videoFullScreen.xml window
	// id=2005
	public static final int ACTION_OSD_SHOW_RIGHT = 70;  // Move right in OSD. Can b used in videoFullScreen.xml
	// window id=2005
	public static final int ACTION_OSD_SHOW_UP = 71;  // Move up in OSD. Can b used in videoFullScreen.xml window
	// id=2005
	public static final int ACTION_OSD_SHOW_DOWN = 72;  // Move down in OSD. Can b used in videoFullScreen.xml window
	// id=2005
	public static final int ACTION_OSD_SHOW_SELECT = 73;  // toggle/select option in OSD. Can b used in
	// videoFullScreen.xml window id=2005
	public static final int ACTION_OSD_SHOW_VALUE_PLUS = 74;  // increase value of current option in OSD. Can b used
	// in videoFullScreen.xml window id=2005
	public static final int ACTION_OSD_SHOW_VALUE_MIN = 75;  // decrease value of current option in OSD. Can b used in
	// videoFullScreen.xml window id=2005
	public static final int ACTION_SMALL_STEP_BACK = 76;  // jumps a few seconds back during playback of movie. Can b
	// used in videoFullScreen.xml window id=2005

	public static final int ACTION_PLAYER_FORWARD = 77;  // FF in current file played. global action,
	// can be used anywhere
	public static final int ACTION_PLAYER_REWIND = 78;  // RW in current file played. global action,
	// can be used anywhere
	public static final int ACTION_PLAYER_PLAY = 79;  // Play current song. Unpauses song and sets playspeed to 1x.
	// global action, can be used anywhere

	public static final int ACTION_DELETE_ITEM = 80;  // delete current selected item. Can be used in myfiles.xml
	// window id=3 and in myvideoTitle.xml window id=25
	public static final int ACTION_COPY_ITEM = 81;  // copy current selected item. Can be used in myfiles.xml window
	// id=3
	public static final int ACTION_MOVE_ITEM = 82;  // move current selected item. Can be used in myfiles.xml window
	// id=3
	public static final int ACTION_SHOW_MPLAYER_OSD = 83;  // toggles mplayers OSD. Can be used in videofullscreen.xml
	// window id=2005
	public static final int ACTION_OSD_HIDESUBMENU = 84;  // removes an OSD sub menu. Can be used in videoOSD.xml
	// window id=2901
	...
	public static final int ACTION_SHOW_OSD_TIME = 123; // displays current time, can be used in videoFullScreen.xml
	// window id=2005
