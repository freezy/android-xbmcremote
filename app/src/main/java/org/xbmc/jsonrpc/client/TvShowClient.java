...
public class TvShowClient extends Client implements ITvShowClient {
	...
	public ArrayList<TvShow> getTvShows(INotifiableManager manager, ObjNode obj, int sortBy, String sortOrder,
										boolean hideWatched) {
		...
		arr.add("playcount");
		arr.add("art");
		sort(obj.p(PARAM_PROPERTIES, arr), sortBy, sortOrder);
	...
	public ArrayList<Season> getSeasons(INotifiableManager manager, TvShow show, boolean hideWatched) {
		...
		arr.add("playcount");
		arr.add("thumbnail");
		ObjNode obj = sort(obj().p("tvshowid", show.id).p(PARAM_PROPERTIES, arr), SortType.TITLE, "ascending");
	...
	public ArrayList<Episode> getRecentlyAddedEpisodes(INotifiableManager manager, boolean hideWatched) {
		...
		arr.add("showtitle");
		arr.add("thumbnail");
		ObjNode obj = obj().p(PARAM_PROPERTIES, arr);
	...
	public ArrayList<Episode> getEpisodes(INotifiableManager manager, ObjNode obj, int sortBy, String sortOrder,
										  boolean hideWatched) {
	...
	public ArrayList<Episode> getEpisodes(INotifiableManager manager, TvShow show, Season season, int sortBy,
		...
		return getEpisodes(manager, obj().p("tvshowid", show.id).p("season", season.number), sortBy, sortOrder,
				hideWatched);
	}
	...
	public TvShow updateTvShowDetails(INotifiableManager manager, TvShow show) {
		...
		ArrayNode arr = arr();
		arr.add("cast");
		ObjNode obj = obj().p("tvshowid", show.id).p(PARAM_PROPERTIES, arr);
	...
	public Episode updateEpisodeDetails(INotifiableManager manager, Episode episode) {
		ArrayNode arr = arr();
		arr.add("cast");
		ObjNode obj = obj().p("episodeid", episode.id).p(PARAM_PROPERTIES, arr);
