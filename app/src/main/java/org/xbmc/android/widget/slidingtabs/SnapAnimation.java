...
class SnapAnimation extends Animation {
	...
	protected void applyTransformation(float interpolatedTime, Transformation t) {
		final int interPadding = mInitialMargin + Math.round((float) (mSliderSnapPosition - mInitialMargin) *
				interpolatedTime);
		final int interBackPosition = mInitialBackPosition + Math.round((float) (mBackSnapPosition -
				mInitialBackPosition) * interpolatedTime);
