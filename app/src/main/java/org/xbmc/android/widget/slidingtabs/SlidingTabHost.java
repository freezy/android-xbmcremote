...
//		mTabWidget.focusCurrentTab(mCurrentTab);
	...
	/**
	 * /**
	 * A sliding tab has an active icon, a passive icon, a big icon and a text.A tab has a tab indicator, content,
	 * and a tag that is used to keep track
	...
	private class IntentContentStrategy implements ContentStrategy {
		...
		public View getContentView() {
			if (mLocalActivityManager == null) {
				throw new IllegalStateException("Did you forget to call 'public void setup(LocalActivityManager " +
						"activityGroup)'?");
			}
