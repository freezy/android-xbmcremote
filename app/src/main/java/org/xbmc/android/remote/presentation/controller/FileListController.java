...
//								break;
							...
							default:
								mControlManager.playFile(new DataResponse<Boolean>() {
														 ...
														 }, item.path, MediaType.getPlaylistType(item.mediaType),
	...
	public void onContextItemSelected(MenuItem item) {
		...
		final FileLocation loc = (FileLocation) mList.getAdapter().getItem(((OneLabelItemView) (
		...
		switch (item.getItemId()) {
			case ITEM_CONTEXT_QUEUE:
				mControlManager.queueFolder(new QueryResponse(mActivity, "Queueing " + loc.path,
						"Error queueing " + loc.path), loc.path, playlistid, mActivity);
				break;
