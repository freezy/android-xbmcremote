...
public abstract class DialogFactory {
	...
	public static Dialog getTrackDetail(final IMusicManager musicManager, final Activity activity, final Album album,
		...
		final File file = new File(ImportUtilities.getCacheDirectory(MediaType.getArtFolder(album.getMediaType()),
				ThumbSize.SMALL), Crc32.formatAsHexLowerCase(album.getCrc()));
		if (file.exists()) {
	 ...
	 */
	public static Dialog getArtistDetail(final IMusicManager musicManager, final Activity activity,
		...
		final File file = new File(ImportUtilities.getCacheDirectory(MediaType.getArtFolder(artist.getMediaType()),
				ThumbSize.MEDIUM), Crc32.formatAsHexLowerCase(artist.getCrc()));
		if (file.exists()) {
