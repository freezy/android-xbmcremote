...
public class MovieLibraryActivity extends SlidingTabActivity implements ViewTreeObserver.OnGlobalLayoutListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// add the tabs
		mTabHost.addTab(mTabHost.newTabSpec("tab_movies", "Movies", R.drawable.st_movie_on,
				R.drawable.st_movie_off).setBigIcon(R.drawable.st_movie_over).setContent(R.id.movielist_outer_layout));
		//mTabHost.addTab(mTabHost.newTabSpec("tab_actors", "Actors", R.drawable.st_actor_on,
		// R.drawable.st_actor_off).setBigIcon(R.drawable.st_actor_over).setContent(R.id.actorlist_outer_layout));
		mTabHost.addTab(mTabHost.newTabSpec("tab_genres", "Genres", R.drawable.st_genre_on,
				R.drawable.st_genre_off).setBigIcon(R.drawable.st_genre_over).setContent(R.id.genrelist_outer_layout));
		...
		mTabHost.setOnTabChangedListener(new OnTabChangeListener() {
			public void onTabChanged(String tabId) {
				...
				if (prefs.getBoolean(PREF_REMEMBER_TAB, false)) {
					getSharedPreferences("global", Context.MODE_PRIVATE).edit().putString(LAST_MOVIE_TAB_ID,
							tabId).commit();
				}
			}
		});
	...
	public void onGlobalLayout() {
		...
		if (prefs.getBoolean(PREF_REMEMBER_TAB, false)) {
			lastTab = (getSharedPreferences("global", Context.MODE_PRIVATE).getString(LAST_MOVIE_TAB_ID,
					"tab_movies"));
	...
	private void initTab(String tabId) {
		if (tabId.equals("tab_movies")) {
			mMovieController.onCreate(MovieLibraryActivity.this, mHandler, (ListView) findViewById(R.id
					.movielist_list));
		}
		//if (tabId.equals("tab_actors")) {
		//	mActorController.onCreate(MovieLibraryActivity.this, mHandler,
		// (ListView)findViewById(R.id.actorlist_list));
		//}
		if (tabId.equals("tab_genres")) {
			mGenresController.onCreate(MovieLibraryActivity.this, mHandler, (ListView) findViewById(R.id
					.genrelist_list));
		}
