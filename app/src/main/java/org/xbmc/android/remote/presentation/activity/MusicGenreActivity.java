...
public class MusicGenreActivity extends SlidingTabActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mTabHost.addTab(mTabHost.newTabSpec("genretab_artists", "Artists", R.drawable.st_artist_on,
				R.drawable.st_artist_off).setBigIcon(R.drawable.st_artist_over).setContent(R.id
				.artistlist_outer_layout));
		mTabHost.addTab(mTabHost.newTabSpec("genretab_albums", "Albums", R.drawable.st_album_on,
				R.drawable.st_album_off).setBigIcon(R.drawable.st_album_over).setContent(R.id.albumlist_outer_layout));
		mTabHost.addTab(mTabHost.newTabSpec("genretab_songs", "Songs", R.drawable.st_song_on,
				R.drawable.st_song_off).setBigIcon(R.drawable.st_song_over).setContent(R.id.songlist_outer_layout));
		...
		mArtistController.onCreate(this, handler, (ListView) findViewById(R.id.artistlist_list)); // first tab can be
		// updated now.
		...
		mTabHost.setOnTabChangedListener(new OnTabChangeListener() {
			public void onTabChanged(String tabId) {
				if (tabId.equals("genretab_artists")) {
					mArtistController.onCreate(MusicGenreActivity.this, handler, (ListView) findViewById(R.id
							.artistlist_list));
				}
				if (tabId.equals("genretab_albums")) {
					mAlbumController.onCreate(MusicGenreActivity.this, handler, (ListView) findViewById(R.id
							.albumlist_list));
				}
				if (tabId.equals("genretab_songs")) {
					mSongController.onCreate(MusicGenreActivity.this, handler, (ListView) findViewById(R.id
							.songlist_list));
				}
			}
		});
