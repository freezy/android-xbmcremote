...
public class MusicGenreListController extends ListController implements IController {
	...
	public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
		...
		final Genre genre = (Genre) mList.getAdapter().getItem(((OneLabelItemView) (((AdapterContextMenuInfo)
	...
	public void onContextItemSelected(MenuItem item) {
		// be aware that this must be explicitly called by your activity!
		final Genre genre = (Genre) mList.getAdapter().getItem(((OneLabelItemView) ((AdapterContextMenuInfo) item
