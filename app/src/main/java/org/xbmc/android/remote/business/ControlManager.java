...
public class ControlManager extends AbstractManager implements IControlManager, INotifiableManager {
	 ...
	 */
	public void playFile(final DataResponse<Boolean> response, final String filename, final int playlistType,
	 ...
	 */
	public void playFolder(final DataResponse<Boolean> response, final String foldername, final int playlistType,
						   final Context context) {
		mHandler.post(new Command<Boolean>(response, this) {
			@Override
			public void doRun() throws Exception {
	 ...
	 * @param context    Context reference
	 */
	public void queueFolder(final DataResponse<Boolean> response, final String foldername, final int playlistType,
							final Context context) {
		mHandler.post(new Command<Boolean>(response, this) {
			@Override
			public void doRun() throws Exception {
	 ...
	 */
	public void addToPlaylist(final DataResponse<Boolean> response, final String fileOrFolder, final int playlistType,
							  final Context context) {
		mHandler.post(new Command<Boolean>(response, this) {
			@Override
			public void doRun() throws Exception {
	 ...
	 */
	public void setPlaylistPos(final DataResponse<Boolean> response, final int playlistId, final int position,
							   final Context context) {
		mHandler.post(new Command<Boolean>(response, this) {
			@Override
			public void doRun() throws Exception {
