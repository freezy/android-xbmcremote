...
public class HomeActivity extends Activity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		SubMenu downloadMenu = menu.addSubMenu(0, MENU_COVER_DOWNLOAD, 0, "Download Covers").setIcon(R.drawable
				.menu_download);
...
//			return true;
			...
			case MENU_COVER_PURGE_CACHE:
				...
				builder.setMessage("All downloaded covers, thumbs and posters will be deleted. Are you really sure " +
						"you" +
						" want to do this?");
	...
	public Dialog onCreateDialog(int id) {
		...
		mProgressDialog.getWindow().setFlags(WindowManager.LayoutParams.FLAG_BLUR_BEHIND,
