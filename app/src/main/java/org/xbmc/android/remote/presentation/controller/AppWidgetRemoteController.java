...
public class AppWidgetRemoteController extends RemoteController implements
	 ...
	 * @param widgetId
	 */
	public static void setupWidgetButton(RemoteViews remoteView, int viewId, Context context, Object caller,
										 String buttonCode, int widgetId, String uri, String action) {
		...
		active.setData(data);
		remoteView.setOnClickPendingIntent(viewId, PendingIntent.getBroadcast(context, 0, active,
