...
public class TvShowLibraryActivity extends SlidingTabActivity implements ViewTreeObserver.OnGlobalLayoutListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// add the tabs
		mTabHost.addTab(mTabHost.newTabSpec("tab_tv", "TV Shows", R.drawable.st_tv_on,
				R.drawable.st_tv_off).setBigIcon(R.drawable.st_tv_over).setContent(R.id.tvshowlist_outer_layout));
		...
		mTabHost.setOnTabChangedListener(new OnTabChangeListener() {
			public void onTabChanged(String tabId) {
				...
				if (prefs.getBoolean(PREF_REMEMBER_TAB, false)) {
					getSharedPreferences("global", Context.MODE_PRIVATE).edit().putString(LAST_TVSHOW_TAB_ID,
							tabId).commit();
				}
			}
		});
	...
	private void initTab(String tabId) {
		if (tabId.equals("tab_tv")) {
			mTvShowController.onCreate(TvShowLibraryActivity.this, mHandler, (ListView) findViewById(R.id
					.tvshowlist_list));
		}
		//if (tabId.equals("tab_actors")) {
		//	mActorController.onCreate(TvShowLibraryActivity.this, mHandler,
		// (ListView)findViewById(R.id.actorlist_list));
		//}
		if (tabId.equals("tab_genres")) {
			mGenresController.onCreate(TvShowLibraryActivity.this, mHandler, (ListView) findViewById(R.id
					.genrelist_list));
		}
		if (tabId.equals("tab_files")) {
			mFileController.onCreate(TvShowLibraryActivity.this, mHandler, (ListView) findViewById(R.id
					.filelist_list));
		}
	}
