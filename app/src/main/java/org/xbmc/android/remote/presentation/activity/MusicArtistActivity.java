...
public class MusicArtistActivity extends SlidingTabActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mTabHost.addTab(mTabHost.newTabSpec("musictab1", "Albums", R.drawable.st_album_on,
				R.drawable.st_album_off).setBigIcon(R.drawable.st_album_over).setContent(R.id.albumlist_outer_layout));
		mTabHost.addTab(mTabHost.newTabSpec("musictab2", "Songs", R.drawable.st_song_on,
		...
		mAlbumController.onCreate(this, handler, (ListView) findViewById(R.id.albumlist_list)); // first tab can be
		// updated now.
		...
		mTabHost.setOnTabChangedListener(new OnTabChangeListener() {
			public void onTabChanged(String tabId) {
				if (tabId.equals("musictab1")) {
					mAlbumController.onCreate(MusicArtistActivity.this, handler, (ListView) findViewById(R.id
							.albumlist_list));
				}
				if (tabId.equals("musictab2")) {
					mSongController.onCreate(MusicArtistActivity.this, handler, (ListView) findViewById(R.id
							.songlist_list));
				}
			}
		});
