...
//	private static final int MENU_INPUT_TEXT = 6;
	...
	public static final int MENU_COVER_DOWNLOAD_EPISODES = 47;
...
//		menu.add(0, MENU_INPUT_TEXT, 0, "Send Text");
		...
		downloadMenu.add(2, MENU_COVER_DOWNLOAD_EPISODES, 0, "TV Episode Posters");
...
//			return true;
		...
		case MENU_COVER_DOWNLOAD_EPISODES:
	...
	protected void onPrepareDialog(int id, Dialog dialog) {
		...
		switch (id) {
			...
			case MENU_COVER_DOWNLOAD_EPISODES:
				...
				mProgressThread = mHomeController.new ProgressThread(mHandler, MENU_COVER_DOWNLOAD_EPISODES, d);
				break;
			default:
				return;
		}
