...
public class ControlManager extends AbstractManager {
	 ...
	 */
	public void playFile(final DataResponse<Boolean> handler, final String filename) {
	 ...
	 */
	public void addToPlaylist(final DataResponse<Boolean> handler, final String fileOrFolder) {
		mHandler.post(new Runnable() {
			public void run() { 
	 ...
	 * @param mediaType
	 */
	public void updateLibrary(final DataResponse<Boolean> handler, final String mediaType) {
		mHandler.post(new Runnable() {
			public void run() {
