...
public class InfoManager extends AbstractManager {
	 ...
	 */
	public void getSystemInfo(final DataResponse<String> handler, final int field) {
	 ...
	 */
	public void getShares(final DataResponse<ArrayList<MediaLocation>> handler, final int mediaType) {
		mHandler.post(new Runnable() {
			public void run() { 
	 ...
	 * @return
	 */
	public void getDirectory(final DataResponse<ArrayList<MediaLocation>> handler, final String path, final DirectoryMask mask, final int offset, final int limit) {
		mHandler.post(new Runnable() {
			public void run() { 
	 ...
	 * @return
	 */
	public void getDirectory(final DataResponse<ArrayList<MediaLocation>> handler, final String path) {
		mHandler.post(new Runnable() {
			public void run() { 
